...
```
cd existing_repo
git remote add origin https://git.uwaterloo.ca/saabaksh/team-101-9.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.uwaterloo.ca/saabaksh/team-101-9/-/settings/integrations)
